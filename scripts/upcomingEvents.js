...
function eventUpcoming(array) {
  if (array.length == 0) {
    contenedorMainUpcoming.innerHTML =  "<h2> No hay elementos </h2>"
    return
  }
  let upcomingEvents = ""
  ...
  contenedorMainUpcoming.innerHTML = upcomingEvents
}
